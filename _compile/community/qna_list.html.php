<?php /* Template_ 2.2.8 2018/03/30 18:30:06 /Users/sonchowon/portfolio/_template/community/qna_list.html 000005079 */ ?>
<!DOCTYPE html>
<html>
<head>
	...
	<div class="container">
		<div class="column1">
			...
			<div class="category_section">
				...
				<ul>
					<li><a href="<?php echo $TPL_VAR["home_url"]?>/community/notice_list.php">NOTICE</a></li>
		...
		<div class="column2">
			...
			<div class="title_wrap">
				<div class="title_box">
					<div class="title_here">
						<span style="font-size: 13px; font-weight: bolder;">Q &amp; A</span>
					</div>
				</div>
			</div>
			<!-- 타이틀 끝 -->
			...
			<div class="list_table">
				<table class="table qna_list">
					...
					<tbody>
						<tr>
							<td class="tb_cate">9</td>
							<td class="tb_title">
								<div class="cut_strings">
									<nobr><a href="<?php echo $TPL_VAR["home_url"]?>/community/read.php">HANBOOK Open EVEefdfgsdsggs</a></nobr></div>
							</td>
			...
			<div class="write_btn float-right">
				<a href="<?php echo $TPL_VAR["home_url"]?>/community/write.php">글쓰기</a>
			</div>
		</div>
	</div>
